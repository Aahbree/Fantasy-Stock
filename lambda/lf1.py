...
def lambda_handler(event, context):
    ...
    for competition in searchData['hits']['hits']:
        if competition['_source']['status'].lower() == "live":
            competitionslive.append(competition['_source'])
        elif competition['_source']['status'].lower() == "yet to start":
            competitionsyet.append(competition['_source'])
        else:
            competitionsclo.append(competition['_source'])
    competitions.extend(competitionslive+competitionsyet+competitionsclo)
